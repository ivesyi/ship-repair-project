import { openShipWorkbench } from './ship-workbench'
...
function installMenu(): void {
  ...
  template.push({label:'船舶工作台',submenu:[{label:'打开业务工作台',accelerator:'CmdOrCtrl+Shift+J',click:()=>{void openShipWorkbench(runtime?.snapshot().url || 'http://127.0.0.1:43130').catch(showUnexpectedError)}}]})
